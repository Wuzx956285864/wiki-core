import javasdk1Img from '@site/static/img/Javasdk1.png'
import javasdk2Img from '@site/static/img/Javasdk2.png'
...
<ImageZoom src={javasdk1Img} />
<ImageZoom src={javasdk2Img} />
