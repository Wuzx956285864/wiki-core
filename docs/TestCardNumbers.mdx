...
2. Select the merchant, select the payment channel "Bankcard Sandbox" and turn on all switches, then click "Submit".
<ImageZoom src={uATOpen} />
3. Ensure that your test payment terminal has been added to the merchant account.
